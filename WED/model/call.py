...
def crdeimg(scal):
    ...
    rec_image = pipe_inference(image = inv_latent,
                            ...
                            guidance_scale = 1.0,
                            omega=scal.omega, # omega=3 for "009698.jpg", omega=5 for "Arknight.jpg"
                            ...
                            edit_threshold = scal.edit_threshold,
                            edit_guidance_scale = scal.edit_guidance_scale,
                            reverse_editing_direction = scal.reverse_editing_direction,
                            t_exit = scal.t_exit, # t_exit=15 for "009698.jpg", t_exit=25 for "Arknight.jpg"
                            ).images[0]
